...
abstract final class ProjectData {
  static const projects = [
    ProjectModel(
      ...
      thumbnailUrl: ProjectStrings.bokloThumbnail,
    ...
    ProjectModel(
      ...
      thumbnailUrl: ProjectStrings.crmThumbnail,
    ...
    ProjectModel(
      ...
      thumbnailUrl: ProjectStrings.kiranaThumbnail,
    ...
    ProjectModel(
      ...
      icon: Icons.work,
      thumbnailUrl: ProjectStrings.jobHubThumbnail,
